...
SECRETS_MAP = {"La Polar": 0}
CLIENTS_MAP = {0: "La Polar"}
selected_client = "La Polar"
...
st.markdown(f"# La Polar routes report")
...
#else:
period = st.sidebar.slider ("Select the depth of the report in days (days since last update)", min_value=1, max_value=30, value=7)
